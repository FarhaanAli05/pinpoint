...
export default function OnboardingPage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-12">
      <h1 className="mb-1 text-2xl font-bold">Create Your Housing Unit</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Distance anchor — static for MVP */}
        <div>
          <label className="mb-1 block text-sm font-medium">
            Distance anchor
          </label>
          <div className="rounded-lg border border-border bg-primary-light px-3 py-2 text-sm text-muted">
