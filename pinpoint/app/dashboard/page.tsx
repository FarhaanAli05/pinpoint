...
const CATEGORY_DESC: Record<ListingCategory, string> = {
  ...
  "looking-for-room-and-roommate": "Looking for a room and a roommate.",
  "have-room-need-roommates": "Have a room, need roommates.",
  "sublet-room": "Subletting a room.",
};
      ...
      <div className="pl-16 relative z-10">
        <div className="max-w-3xl mx-auto py-12 px-6">
          ...
          <p className="text-center text-zinc-500 text-sm mb-8">
            ...
            {" · "}
            <Link href="/dashboard/person-profile" className="text-zinc-600 dark:text-zinc-400 underline hover:text-zinc-950 dark:hover:text-white">
              Your preferences
            </Link>
            {" · "}
